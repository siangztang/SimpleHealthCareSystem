...
public class ParameterTypes {
    ...
    public final static Class<?>[] PATIENT_PARAMETER_TYPES = {String.class, String.class, String.class, int.class, char.class, String.class, String.class};
    ...
    public final static Class<?>[] URINE_ANALYSIS_PARAMETER_TYPES = {String.class, double.class, String.class, double.class, String.class, String.class, String.class};
